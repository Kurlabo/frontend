...
const Register = () => {
  ...
  const regForm = 'text-formTitle';
  const regTitle = 'font-bold text-left align-top pt-7 ';
  const regInput = 'border-solid border border-inputGray w-formInput h-16 px-6';
  const subText = 'text-formSub text-gray-600';
  // const regInputDate = 'border-solid border border-inputGray w-formInput h-16 px-6';
  const formButton =
    'w-48 ml-2 font-bold text-kp-600 border-kp-600 border-solid border rounded h-16.5';
  const formTdButton =
    'w-formInput font-bold text-kp-600 border-kp-600 border-solid border rounded h-16.5';
  ...
  const onChangePass = e => {
    ...
    var pwRegExp1 = /^(?=.*[a-z])(?=.*[A-Z])(?=.*d)[a-zA-Zd]{8,}$/;
    var pwRegExp2 = /(\d){3,}/;

    pass.length > 10 ? setValidPass1(true) : setValidPass1(false);
    pwRegExp1.test(pass) ? setValidPass2(true) : setValidPass2(false);
    pwRegExp2.test(pass) ? setValidPass3(false) : setValidPass3(true);
  };

  const onChangeRePass = e => {
    setrePass(e.target.value);
    pass && pass === repass ? setValidRePass(true) : setValidRePass(false);
  };
  ...
  return (
    <div className="w-formWidth ml-auto mr-auto pb-48">
      ...
      <form className={regForm} onSubmit={onSubmit}>
        <table className="ml-auto mr-auto">
          ...
          <tr>
            ...
            <td className="py-4">
              <button className={formTdButton}>주소검색</button>
          ...
          <tr>
            ...
            <td className="py-4">
              <div className="w-1/3 inline-block">
                <input type="radio" id="gender1" name="gender" value="man" className={formRadio} />
                <label for="gender1" className="align-top">
                  남자
                </label>
              </div>
              <div className="w-1/3 inline-block">
                <input
                  ...
                  className={formRadio}
                />
                <label for="gender2" className="align-top">
                  여자
                </label>
              </div>
              <div className="w-1/3 inline-block">
                <input type="radio" id="gender3" name="gender" value="none" className={formRadio} />
                <label for="gender3" className="align-top">
                  선택안함
                </label>
              </div>
            </td>
          ...
          <tr>
            ...
            <td className="py-4" colSpan="2">
              <div className="py-4">
                <input type="radio" name="allTerms" id="allTerms" className={formRadio} />
                <label for="allTerms" style={radioLabel}>
                  전체약관동의
                </label>
              ...
              <div className="py-4">
                ...
                <div className="pl-14">
                  <input
                    ...
                    className="mr-5"
                  />
                  <label for="contactChoice1" className="pr-32">
                    SMS
                  </label>
                  <input
                    type="radio"
