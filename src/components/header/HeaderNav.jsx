...
const headerFix =
  'w-full fixed bg-white top-0 z-900 transform duration-75 border-gray-50 border-b-4 pt-4';
const headerRel = 'w-full bg-white z-900 transform duration-75 border-gray-50 border-b-4 relative';
