  ...
  return (
    <div className="w-2/4">
      ...
      <div class="company">
        ...
        <br />
        입점문의 :{' '}
        <a href="https://forms.gle/oKMAe1SaicqMX3SC9" target="_blank" class="link">
          입점문의하기
        </a>{' '}
        <span class="bar">I</span> 제휴문의 :{' '}
        <a href="mailto:business@kurlycorp.com" class="link">
          business@kurlycorp.com
        </a>
        <br />
        채용문의 :{' '}
        <a href="mailto:recruit@kurlycorp.com" class="link">
          recruit@kurlycorp.com
        </a>
        <br />
        팩스: 070 - 7500 - 6098 <span class="bar">I</span> 이메일 :{' '}
        <a href="mailto:help@kurlycorp.com" class="link">
          help@kurlycorp.com
        </a>
