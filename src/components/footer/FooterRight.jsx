  ...
  return (
    <div className="w-2/4 pt-12">
      ...
      <div className="text-r-1.2 text-kmi-100">
        ...
        <br />
        입점문의 :{' '}
        <a href="https://forms.gle/oKMAe1SaicqMX3SC9" target="_blank" className="text-kp-600">
          입점문의하기
        </a>{' '}
        <span class="bar">I</span> 제휴문의 :{' '}
        <a href="mailto:business@kurlycorp.com" className="text-kp-600">
          business@kurlycorp.com
        </a>
        <br />
        채용문의 :{' '}
        <a href="mailto:recruit@kurlycorp.com" className="text-kp-600">
