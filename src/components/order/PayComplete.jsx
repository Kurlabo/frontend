      ...
      <div className="flex flex-col items-center mx-auto bg-white w-r-42.6">
        <div className="w-full">
          ...
          <div className="text-r-1.6 text-gray-600 pt-r-1.4 pl-r-1.6 font-medium ">
            ...
            <p className="text-kp-600">네이버 페이</p>
          </div>
          <div className="text-r-1.6 text-gray-600 pt-r-1.4 pl-r-1.6 font-medium ">
            <h2>결제금액</h2>
            <p className="text-gray-800 font-semibold pb-r-1.1 text-r-1.8">3,400원</p>
          ...
          <div className="text-r-1.7 text-gray-600 pt-r-1.4 pl-r-1.6 pr-r-1.6">
            ...
            <Link className=" block border border-gray-200 text-gray-900 rounded-p-3 py-r-0.9 text-center">
              주문내역 상세보기
            </Link>
          </div>
          <p className="text-gray-700 py-r-1.3 px-r-1.6 text-r-1.5">
            <span className="font-bold">'입금확인'</span>상태일 때는 주문내역 상세 페이지에서 직접
            주문 취소가 가능합니다.
          </p>
        </div>
      </div>
