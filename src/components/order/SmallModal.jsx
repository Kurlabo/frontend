...
const modalWrapper =
  'w-r-19 py-r-1.4 pl-r-1.4 pr-r-3.6 top-16 -right-3 h-24 text-1.2 text-white bg-klp-150 text-left rounded-lg absolute';
...
const SmallModal = ({ onClose }) => {
  return (
    <div className={modalWrapper}>
      ...
      <p>장바구니,홈에서</p>
      <p>배송지를 변경할 수 있어요.</p>
      <button className="absolute top-5 right-5 focus:outline-0" onClick={onClose}>
